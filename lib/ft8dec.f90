subroutine ft8dec(iwave,nQSOProgress,nfqso,nftx,newdat,        &
...
!           flush(81)
           if(.not.ldupe) then
              ...
              write(*,1010) min(sync,999.0),nsnr,xdt,nint(f1),   &
                   iaptype,qual,msg37
1010          format(f5.1,i4,f5.2,i5,i3,f5.1,1x,a37)
           endif
        endif
      enddo
  enddo
  return
end subroutine ft8dec
